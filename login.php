              ...
              <form method="POST" enctype="multipart/form-data" action="login_process.php">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input required class="form-control" placeholder="Univ Id" name="uid" type="text">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <input id="signin" type="submit" class="btn btn-primary my-4" value="Sign In"></input>
                </div>
              </form>
            </div>
          </div>
