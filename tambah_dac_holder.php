                                    ...
                                    <div class="table-responsive py-4">
                                        <table class="table table-flush" id="datatable-basic">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $mysqli->select_db('presensi_cloud');
                                                $sql = "select * from users u where id not in (select drole.user_id from dac_roles drole where drole.dac_rule_id = ?) and u.jabatan!='mhs' ORDER BY u.nama ASC";
                                                $stmt = $mysqli->prepare($sql);
                                                $stmt->bind_param("i", $roleid);
                                                $stmt->execute();
                                                $res = $stmt->get_result();
                                                ...
                                                while ($row = $res->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-actions">
                                                            <form method="POST" enctype="multipart/form-data" action="dacroles_process.php">
                                                                <input type="hidden" name="roleid" value="<?php echo $roleid; ?>">
                                                                <input type="hidden" name="userid" value="<?php echo $userid; ?>">
                                                                <input type="submit" name="addholder" class="btn" value="Add Holder">
                                                            </form>
                                                        </td>
                                                        <!-- Edit Delete -->
                                                    </tr>
